		...
		<SafeAreaView style={{ flex: 1 }}>
			...
			<View style={styles.contain}>
				<View>
					...
					<Text style={styles.text}>1. Your temperature:</Text>
					<SingleCheckbox
						selectionMode={''}
						optionlist={['≥37.3°C', '<37.3°C']}
						onSelectSwitch={() => {}}
					/>
					<Text style={styles.text}>2. Your recent Covid-19 Test result:</Text>
					<SingleCheckbox
						selectionMode={''}
					...
					<Text style={styles.text}>5. Highly exposed position personnel:</Text>
					<MultiCheckbox
						selectionMode={''}
						optionlist={[
						...
						onSelectSwitch={() => {}}
					/>
					<Text style={styles.text}>6. Clinical symptoms:</Text>
					<MultiCheckbox
						selectionMode={''}
						optionlist={[
							'Fever',
